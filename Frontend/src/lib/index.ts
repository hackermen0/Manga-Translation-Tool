...
import LayerCard from './components/Right Sidebar/LayerCard.svelte';
import Layers from './components/Right Sidebar/LayersPanel.svelte';
import TranslationPanel from './components/Right Sidebar/TranslationPanel.svelte';
...
import GlossaryCard from './components/Right Sidebar/GlossaryCard.svelte';
import GlossaryButton from './components/Right Sidebar/GlossaryButton.svelte';
