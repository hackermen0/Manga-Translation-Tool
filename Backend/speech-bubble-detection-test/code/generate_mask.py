...
if __name__ == "__main__":
    MODEL_PATH = r"C:\Users\KIIT\Documents\Coding Projects\Python projects\On-going Projects\Manga Translation Tool\Backend\models\bubble_detector.pt"  # path to your trained model
